...
> Tài liệu tổng hợp cách cài đặt, sử dụng VS Code, kết nối GitHub và tạo schedule task tự động viết bài với Claude Code.
...
2. [Kết nối GitHub](#phần-2-kết-nối-github)
3. [Claude Code - Slash Commands](#phần-3-claude-code---slash-commands-lệnh)
4. [Tạo Schedule Task viết bài tự động](#phần-4-tạo-schedule-task-viết-bài-tự-động)
5. [Workflow đề xuất cho viết bài SEO](#phần-5-workflow-đề-xuất-viết-bài-seo)
6. [Phím tắt VS Code phổ biến](#phần-6-phím-tắt-vs-code-phổ-biến)
7. [Mẹo cho người mới](#mẹo-cho-người-mới)
...
Bấm icon 4 ô vuông bên trái (`Ctrl + Shift + X`), tìm và cài:

| Extension | Công dụng |
|---|---|
| **Claude Code** (Anthropic) | Quan trọng nhất - AI trợ lý |
| **Vietnamese Language Pack** | Giao diện tiếng Việt |
| **Prettier** | Format code tự động |
| **GitLens** | Xem lịch sử Git chi tiết |
| **Markdown All in One** | Viết file .md tiện lợi |

### Bước 3: Cài đặt giao diện
`Ctrl + Shift + P` gõ `settings` chọn "Preferences: Open Settings (UI)"

- **Font Size**: 14-16 (dễ đọc)
- **Word Wrap**: on (tự xuống dòng)
- **Auto Save**: afterDelay (tự lưu)
- **Theme**: `Ctrl + K` rồi `Ctrl + T` để đổi màu nền

---

## PHẦN 2: Kết nối GitHub
...
Mở Claude Code trong VS Code: `Ctrl + Shift + P` gõ `Claude` chọn Open Claude Code
...
| `/loop 5m /lệnh` | Chạy lệnh lặp lại mỗi 5 phút |
| `/schedule` | Tạo task chạy tự động theo lịch |
...
## PHẦN 4: Tạo Schedule Task viết bài tự động
...
## PHẦN 5: Workflow đề xuất viết bài SEO
...
## PHẦN 6: Phím tắt VS Code phổ biến
